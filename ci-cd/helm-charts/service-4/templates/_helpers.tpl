...
helm.sh/chart: {{ include "service-4.chart" . }}
{{ include "service-4.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "service-4.fullname" .) .Values.serviceAccount.name }}
{{- else }}
